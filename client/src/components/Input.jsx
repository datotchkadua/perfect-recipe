...
const Input = ({svg,placeholderText,name,type, register,
  errors,}) => {
  ...
  {...register(name)}
    className={
     ...
     outline-none 
  ${ errors[name]?.message   ?
"border-red-500 focus:ring-red-500 focus:border-red-500  ": null}
      `
     }
...
{errors[name] && <p className="mb-2 text-sm text-red-600 dark:text-red-500">
